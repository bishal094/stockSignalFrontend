...
@Component({
  selector: "app-add-stock-data",
  templateUrl: "./add-stock-data.component.html",
  styleUrls: ["./add-stock-data.component.css"],
})
export class AddStockDataComponent implements OnInit {
